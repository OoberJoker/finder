 ...
 * Use the {@link PageSelectionFragment#newInstance} factory method to
...
public class PageSelectionFragment extends Fragment {
    ...
    public static PageSelectionFragment newInstance() {
        Log.i("PageSelectionF","Reached");
        PageSelectionFragment fragment = new PageSelectionFragment();
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        Log.i("fragment","Reached");
        super.onActivityCreated(savedInstanceState);

        Button checkPostingButton = (Button)getView().findViewById(R.id.fragmentCheckPosting);
        ...
        Button postButton = (Button)getView().findViewById(R.id.fragmentPostSomething);
